...
dtps.init = function () {
    ...
    sudoers = ["10838212", "10894474", "10463823"]
    ...
    contributors = ["10463823", "10894474"]
    if (contributors.includes(HaikuContext.user.login)) { jQuery("body").addClass("contributor"); }
    if (HaikuContext.user.login === 2349803459834598) { jQuery("body").addClass("dev"); dtps.log("Dev mode enabled"); fluidThemes[0].push({ name: "d.tech", id: "darkDtech", icon: "school" }); }
