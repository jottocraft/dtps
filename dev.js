...
<div onclick="dtps.selectedClass = 'dash';" class="class masterStream ` + streamClass + `">
  ...
  $( ".class:not(.google)" ).click(function(event) {
	  ...
	  if (dtps.fadedColors) prev = "linear-gradient(to bottom right, " + window.getComputedStyle(document.getElementsByClassName("background")[0]).getPropertyValue($("body").hasClass("dark") ? "--norm" : "--light") + ", " + jQuery("body").css("background-color") + ")"
	  $(".btn.google").hide();
	  $(".background").css("background", prev);
		  ...
		  if (dtps.fadedColors) next = "linear-gradient(to bottom right, " + window.getComputedStyle(document.getElementsByClassName("background")[0]).getPropertyValue($("body").hasClass("dark") ? "--norm" : "--light") + ", " + jQuery("body").css("background-color") + ")"
