...
<div class="header">
    ...
    <h3>About</h3>
    <h5>Project DTPS ` + dtps.readableVer.replace("(beta)", `<div class="beta notice">beta</div>`) + ` (user <i style="vertical-align: middle;" class="material-icons dev">experiment</i>&nbsp;` + dtps.user.login + `)</h5>
