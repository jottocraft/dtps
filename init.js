...
dtps.render = function() {
  ...
  dtps.selectedContent = "stream";
	...
	var trackDom = "";
	if (dtps.trackSuffix !== "") {
	    dtps.readableVer.replace(dtps.trackSuffix, `<div style="display:inline-block;" class="beta badge notice">` + dtps.trackSuffix.replace(" (", "").replace(")", "") + `</div>`)
	    }
  jQuery("body").html(`
    <div class="sidebar">
    </div>
