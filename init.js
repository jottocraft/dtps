...
<div class="header">
    ...
    <h3>About</h3>
    <h5>Project DTPS ` + dtps.readableVer.replace(dtps.trackSufix, `<div style="display:inline-block;" class="beta badge notice">` + dtps.trackSuffix.replace(" ", "").replace("(", "").replace(")", "") + `</div>`) + `</h5>
