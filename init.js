...
window.dataLayer = window.dataLayer || [];
  ...
  if ((window.location.host !== "dtechhs.learning.powerschool.com") && ((window.location.host !== "mylearning.powerschool.com") || (HaikuContext.user.login.split(".")[0] !== "dtps"))) {
    ...
    if (window.localStorage.dtpsInstalled !== "true") {
	  ...
	  dtps.shouldRender = false;
    dtps.alert("Power+ is offline", "Power+ has been having unexpected issues for the past few days. With the release of v1.2.0 today, those issues were expected to be resolved but are still present. I'm sorry for the issues and expect to fix Power+ by 5:30PM PDT tonight. Until then, you can try the dev version of Power+, or use PowerSchool normally. For more information about Power+ v1.2.0, check out the changelog at https://github.com/jottocraft/dtps/releases.<br /><br />-Jackson");
  }
