...
dtps.nativeAlert = function (text, sub, loadingSplash) {
    ...
    if (loadingSplash) {
        jQuery("body").append(`<div id="TB_overlay" style="position: fixed; opacity: 0.9;">&nbsp;<h1 style="position: fixed;font-size: 125px;background: -webkit-linear-gradient(rgb(255, 167, 0), rgb(255, 244, 0));-webkit-background-clip: text;-webkit-text-fill-color: transparent;font-weight: bolder;font-family: Product sans;text-align: center;top: 200px;width: 100%;">Power+</h1><h5 style="font-family: Product sans;font-size: 30px;color: gray;width: 100%;text-align: center;position: fixed;top: 300px;">` + sub + `</h5><div class="spinner" style="margin-top: 500px;"> <div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div>
...
<div onclick="dtps.selectedClass = 'dash';" class="class masterStream ` + streamClass + `">
    ...
    <div onclick="dtps.selectedClass = 'cavs';" class="class">
    <div class="name">Community Agreements</div>
    <div class="grade"><i class="material-icons">gavel</i></div>
    </div>
    <div class="classDivider"></div>
  ` + dtps.classlist.join(""));
...
<p>An error occured</p>
  ...
  `);
    ...
    jQuery.getScript("https://cdn.rawgit.com/showdownjs/showdown/1.8.6/dist/showdown.min.js", function () {
		...
		jQuery(".card.changelog").html(`<i onclick="fluid.cards.close('.card.changelog')" class="material-icons close">close</i><h4>Power+ for Canvas Preview</h4><p>You've been invited to test Power+ on Canvas. If you're interested, click <a href="https://jottocraft.github.io/dtps-pub-dp/">here</a> for more details.</p>`);
